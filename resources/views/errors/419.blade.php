...
@section('title', 'Page Expired - WUMIYIN & MASE NIGERIA LIMITED')
	...
	<div class="auto-container">
		<div class="error-block text-center">
			<div class="inner-box">
				...
				<h2 class="title mb-20" style="font-weight: 800; font-size: 36px; color: #000000;">Session Expired</h2>
				<p class="text mb-40" style="font-size: 18px; color: #666666; max-width: 600px; margin: 0 auto 30px auto; line-height: 1.8;">
					Your session has expired due to inactivity. Please refresh the page and try submitting the form again.
				</p>
				<div class="btn-box">
					<a href="{{ url()->previous() }}" class="theme-btn btn-style-one"><span class="btn-title">Go Back</span></a>
