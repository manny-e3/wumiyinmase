...
@section('title', 'Server Error - WUMIYIN & MASE NIGERIA LIMITED')
...
<section class="error-section pt-120 pb-120">
	<div class="auto-container">
		<div class="error-block text-center">
			<div class="inner-box">
				<div class="icon-box mb-30" style="font-size: 100px; color: #dc3545;">
					<i class="fa fa-exclamation-triangle"></i>
				</div>
				<h2 class="title mb-20" style="font-weight: 800; font-size: 36px; color: #000000;">Internal Server Error</h2>
				<p class="text mb-40" style="font-size: 18px; color: #666666; max-width: 600px; margin: 0 auto 30px auto; line-height: 1.8;">
					Something went wrong on our servers. We are already working to resolve the issue. Please try again later.
				</p>
				<div class="btn-box">
